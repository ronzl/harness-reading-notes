...
│                                                                                                      │
│  ┌──────────────────────┐  ┌──────────────────────────────┐  ┌────────────────────────────┐        │
│  │     信仰层：天道       │  │      方法层：四原则+六步法       │  │      工具层：判断+风控       │        │
│  │                      │  │                              │  │                            │        │
│  │  ┌────────────────┐  │  │  ┌─── 核心四原则 ─────────┐  │  │  ┌─── 信号评分卡 ──────┐  │        │
│  │  │ 价格由供需决定   │  │  │  │ ① 物极必反            │  │  │  │ 价格 / 利润 / 供应  │  │        │
│  │  │ 而不是K线或庄家  │  │  │  │ ② 成本决定底部        │  │  │  │ 库存 / 情绪 / 资金  │  │        │
│  │  └────────────────┘  │  │  │ ③ 供需决定一切        │  │  │  │ 6维度×0-2分，≥7行动 │  │        │
│  │                      │  │  │ ④ 极端情绪是反向指标    │  │  │  └────────────────────┘  │        │
│  │  ┌────────────────┐  │  │  └────────────────────────┘  │  │                            │        │
│  │  │ 天道 = 自然规律  │  │                              │  │  ┌─── 成本核算法 ──────┐  │        │
│  │  │ 规律不可违抗     │  │  ┌─── 六步操作系统 ─────────┐  │  │  │ 农产品：种植成本    │  │        │
│  │  └────────────────┘  │  │  │ ① 选品：算成本/看周期   │  │  │  │ 工业品：生产成本    │  │        │
│  │                      │  │  │ ② 调研：实地确认        │  │  │  │ 金融股：内含价值    │  │        │
│  │                      │  │  │ ③ 等待：极端信号集齐    │  │  │  └────────────────────┘  │        │
│  │                      │  │  │ ④ 建仓：60-70%分批次   │  │  │                            │        │
│  │                      │  │  │ ⑤ 持仓：看基本面死扛    │  │  │  ┌─── 红线列表 ──────┐  │        │
│  │                      │  │  │ ⑥ 平仓：反转信号出现   │  │  │  │ 不做短线/不预测点位 │  │        │
│  │                      │  │  └────────────────────────┘  │  │  │ 成本以下不止损      │  │        │
│  │                      │  │                              │  │  │ 需求消失不抄底      │  │        │
│  │                      │  │  ┌─── 三大战役 ───────────┐  │  │  └────────────────────┘  │        │
│  │                      │  │  │ ① 2010棉花：5万→1.2亿  │  │  │                            │        │
...
│  ├──────────────────────┤  │  └────────────────────────┘  │  ├────────────────────────────┤        │
│  │  "天道就是供需，      │  │                              │  │  持仓心法：                  │        │
│  │   供需就是天道"      │  │  ═══════ 傅式投资铁律 ═══════  │  │  · 不看账户浮亏看基本面      │        │
│  │    —— 傅海棠         │  │  选标的 → 算成本 → 等极端      │  │  · 忍受20-30%正常回撤        │        │
│  └──────────────────────┘  │  → 重仓入 → 死扛 → 反转走     │  │  · 关掉交易群避免噪音        │        │
│                             └──────────────────────────────┘  └────────────────────────────┘        │
└──────────────────────────────────────────────────────────────────────────────────────────────────┘
```
